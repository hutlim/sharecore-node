...
/**
 * Will return the path and default sharecore-node configuration. It will search for the
 * configuration file in the "~/.sharecoin" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.sharecoin');
  var defaultConfigFile = path.resolve(defaultPath, './sharecore-node.json');
