...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `sharecore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ sharecore-node add wallet-service');
      console.log('    $ sharecore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ sharecore-node remove wallet-service');
      console.log('    $ sharecore-node remove insight-api');
      console.log();
    });
